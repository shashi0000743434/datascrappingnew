...
//$inbox = imap_open("{p3plcpnl0270.prod.phx3.secureserver.net}INBOX", "corporateleads@enzymelabssetup.com", "Howard321!") or die('Cannot connect to Email: ' . imap_last_error());
//$inbox = imap_open("{a2plvcpnl40763.prod.iad2.secureserver.net}INBOX", "corporateleads@enzymelabssetup.com", "Howard321!") or die('Cannot connect to Email: ' . imap_last_error());
$inbox = imap_open("{p3plvcpnl54594.prod.phx3.secureserver.net}INBOX", "corporateleads@enzymelabssetup.com", "Howard321!") or die('Cannot connect to Email: ' . imap_last_error());
