<?php
	...
	if(mysqli_num_rows($property_Query)>0){
		while ($db_field = mysqli_fetch_assoc($property_Query)) {		
				...
				->setTo(array('leadinfo@brightwaycoleagency.com'=> 'Cat4WebsiteLeads LEAD','enzymelabs1@a2plvcpnl17954.prod.iad2.secureserver.net'=> 'Cat4WebsiteLeads LEAD','cpanel@enzymelabssetup.com'=> 'Cat4WebsiteLeads LEAD'))
