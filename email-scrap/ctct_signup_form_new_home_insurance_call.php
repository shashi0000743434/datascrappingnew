<?php
	...
	**/	
	...
	$sqlproperty_Query="select * from scrapped_datalot_new_home_insurance_call where ctct_status = 0"; 	
	//$sqlproperty_Query="select * from scrapped_datalot_new_home_insurance_call where id = 2"; 		
	...
	if(mysqli_num_rows($property_Query)>0){
		while ($db_field = mysqli_fetch_assoc($property_Query)) {		
			...
			$cell_phone		=	str_replace(')','',str_replace('(','',$db_field['cell_phone']));
			...
			$postinfo = "ca=646de8a9-5977-4980-8328-a1f979584361&list=1321447010&source=EFD&required=list,email,first_name&url=&email=$email&first_name=$first_name&last_name=$last_name&phone=$phone&address_street=$street_address&address_city=$city&address_state=$state&address_postal_code=$postal_code&cf_text_value--0=$cell_phone&cf_text_name--0=cell_phone&cf_text_label--0=Cell Phone&cf_text_value--1=$city&cf_text_name--1=city&cf_text_label--1=city&cf_text_value--2=$street_address&cf_text_name--2=street_address&cf_text_label--2=street_address&cf_text_value--3=$val3&cf_text_name--3=what_is_the_schedule_a_value_of_your_home&cf_text_label--3=what_is_the_schedule_a_value_of-your-home?&cf_text_value--4=$year_built&cf_text_name--4=year_house_built&cf_text_label--4=Year House Built&cf_text_value--5=$postal_code&cf_text_name--5=zip_code&cf_text_label--5=zip_code";
			...
			if($response==1){
				...
				// update the table.
				$sql_update="update scrapped_datalot_new_home_insurance_call set ctct_status = 1 where id='".$id."'";
