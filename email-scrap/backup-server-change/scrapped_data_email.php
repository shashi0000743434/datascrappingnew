<?php
	...
	if(mysqli_num_rows($property_Query)>0){
		while ($db_field = mysqli_fetch_assoc($property_Query)) {		
				...
				->setTo(array('leadinfo@brightwaycoleagency.com'=> 'OtherLeadSources LEAD','enzymelabs1@p3plcpnl0270.prod.phx3.secureserver.net'=> 'OtherLeadSources LEAD','cpanel@enzymelabssetup.com'=> 'OtherLeadSources LEAD'))
